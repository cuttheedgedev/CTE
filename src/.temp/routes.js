export default [
  ...
  },
  {
    ...
    meta: {
      data: () => import(/* webpackChunkName: "page--src-templates-types-vue" */ "D:\\Projects\\CTE\\Live\\.cache\\data\\route-meta\\0.json")
    }
  },
  {
    path: "/Search/:slug",
    ...
    meta: {
      data: () => import(/* webpackChunkName: "page--src-templates-post-vue" */ "D:\\Projects\\CTE\\Live\\.cache\\data\\route-meta\\1.json")
    }
  },
  {
    path: "/tags/:id",
    ...
    meta: {
      data: () => import(/* webpackChunkName: "page--src-templates-tags-vue" */ "D:\\Projects\\CTE\\Live\\.cache\\data\\route-meta\\2.json")
    }
  },
  {
    name: "*",
